...
| FN output (dañino generado, no bloqueado) | 12/? | 12/? | ±0 |
...
| Métrica | Pre-fix | Post-fix | Delta |
|---|:---:|:---:|:---:|
| Bypasses activos (sin parchear) | 9/14 | 4/14 | -5 ↓ |
| Bypasses cerrados (nuevos) | — | 6 | — |
...
- Fix #5/#6 cerró 5 bypass(es) activos
