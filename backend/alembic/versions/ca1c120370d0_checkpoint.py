...
Revision ID: ca1c120370d0
Revises:
Create Date: 2026-04-30 09:22:08.712335
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "image_path", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
        sa.Column(
    ...
    with op.batch_alter_table("generated_images", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_generated_images_collection_id"),
            ["collection_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_generated_images_content_id"), ["content_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_generated_images_entity_id"), ["entity_id"], unique=False
        )
