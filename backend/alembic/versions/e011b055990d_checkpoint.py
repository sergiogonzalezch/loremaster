...
def upgrade() -> None:
    ...
    with op.batch_alter_table("collections", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_collections_owner_id"),
            ["owner_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("documents", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_documents_collection_id"),
            ["collection_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("entities", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_entities_collection_id"),
            ["collection_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("generated_texts", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_generated_texts_entity_id"),
            ["entity_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("entity_contents", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_entity_contents_entity_id"),
            ["entity_id"],
            unique=False,
        )
        batch_op.create_index(
