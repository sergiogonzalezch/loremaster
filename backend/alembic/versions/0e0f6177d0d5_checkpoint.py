...
def upgrade() -> None:
    ...
    sa.Column('category', sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False),
    sa.Column('auto_prompt', sqlmodel.sql.sqltypes.AutoString(length=2000), nullable=False),
    sa.Column('final_prompt', sqlmodel.sql.sqltypes.AutoString(length=2000), nullable=False),
