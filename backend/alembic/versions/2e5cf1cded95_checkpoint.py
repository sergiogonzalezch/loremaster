...
Revision ID: 2e5cf1cded95
Revises: 
Create Date: 2026-05-13 17:40:03.430894
...
def upgrade() -> None:
    ...
    sa.Column('updated_by', sqlmodel.sql.sqltypes.AutoString(length=36), nullable=True),
    sa.ForeignKeyConstraint(['owner_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name', 'owner_id', name='uq_collection_name_owner')
    )
