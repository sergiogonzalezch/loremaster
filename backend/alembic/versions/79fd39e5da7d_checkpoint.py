...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("pending", "confirmed", "discarded", name="draftstatus"),
            nullable=False,
        ),
        sa.Column("created_at", sa.DateTime(), nullable=False),
    ...
    with op.batch_alter_table("entity_text_drafts", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_entity_text_drafts_collection_id"),
            ["collection_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_entity_text_drafts_entity_id"), ["entity_id"], unique=False
        )
