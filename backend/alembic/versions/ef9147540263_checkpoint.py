...
Revision ID: ef9147540263
Revises: 
Create Date: 2026-04-30 23:58:03.697939
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('generated_images', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_generated_images_collection_id'), ['collection_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_generated_images_content_id'), ['content_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_generated_images_entity_id'), ['entity_id'], unique=False)
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('generated_images', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_generated_images_entity_id'))
        batch_op.drop_index(batch_op.f('ix_generated_images_content_id'))
        batch_op.drop_index(batch_op.f('ix_generated_images_collection_id'))
